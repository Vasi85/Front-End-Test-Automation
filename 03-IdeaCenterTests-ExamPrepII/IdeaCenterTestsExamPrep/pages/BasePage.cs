...
namespace IdeaCenterTestsExamPrep.pages
{
    public class BasePage
    {
        ...
        public IWebElement MyIdeasLink => driver.FindElement(By.CssSelector("a.btn.btn-sm.btn-outline-secondary[href*='/Ideas/Edit']")
);

        public IWebElement CreateIdeaLink => driver.FindElement(By.XPath("//a[@class='nav-link' and text()='Create Idea']"));

        public IWebElement LogoutBtn => driver.FindElement(By.XPath("//a[@class='btn btn-primary me-3']"));

        public IWebElement LoginBtn => driver.FindElement(By.XPath("//a[@class='btn btn-outline-info px-3 me-2']"));
